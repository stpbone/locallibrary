...
# Book Genre model: This model is used to store information about the book category
...
# model representing a language in which the book is written
...
# information about whether the copy is available or on what date it is expected back, 
...
# The model defines an author as having a first name, 
# last name, date of birth, and (optional) date of death.
